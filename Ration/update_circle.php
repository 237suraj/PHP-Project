...
include("top.php"); ?>
       ...
       <?php 
	   		...
	   		$id=$_GET['id'];
			$sql = "select * from circle where Circle_id=:id";
       ...
       <div class="jumbotron container panel panel-success" align="center">
       		...
       		<form class="form-horizontal" action="wk_update_circle.php" method="post">
        		<strong style="font-size:20px;">Circle name : </strong>
                <input type="text" placeholder="<?php echo $row['Circle_name']; ?>" name="name" id="name"/>&nbsp;&nbsp;&nbsp;
        		<input class="btn-danger" style="border-radius:10px; font-size:18px; margin-top:5px" type="submit" value="Update"/>
