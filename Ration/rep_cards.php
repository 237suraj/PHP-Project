...
include("top.php"); ?>
       ...
       <div class="container">
       		<div class="well">
            	<form action="wk_rep_cards.php" method="post">
                	 <table align="center" style="font-size:18px">
                        ...
                        <td>&nbsp;<select name="vid" id="villageid" style="width:210px" >
                    ...
                    <div align="center">
                    <input class="btn-primary" style="border-radius:10px; font-size:18px;" type="submit" value="Display" /></div>
                </form>
            </div><!--class well -->
